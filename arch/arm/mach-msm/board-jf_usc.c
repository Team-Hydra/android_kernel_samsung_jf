...
static struct sec_jack_zone jack_zones_rev3[] = {
	[0] = {
		.adc_high	= 3,
		.delay_us	= 10000,
		.check_count	= 10,
...
static struct sec_jack_buttons_zone jack_buttons_zones_rev3[] = {
	{
		.code		= KEY_MEDIA,
		.adc_low	= 0,
		.adc_high	= 225,
...
static void sec_jack_init(void)
{
	...
	if (system_rev >= BOARD_REV07) {
		...
		sec_jack_data.zones = jack_zones_rev3;
		sec_jack_data.buttons_zones = jack_buttons_zones_rev3;
	}
